...
void APawnTank::Tick(float DeltaTime)
{
	...
	if (PlayerController)
	{
		...
		APawnBase::RotateTurret(HitLocation);
	}
}
...
void APawnTank::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("RotateTurret", this, &APawnTank::CalculateRotationInput);
...
void APawnTank::CalculateRotationInput(float Value)
{
	...
	RotationDirection = FQuat(FRotator(0, RotateAmount, 0));
}
